...
<body style="border-color: #ffffff;">
    ...
    <div role="tablist" id="accordion-1">
        ...
        <div class="card" style="background: rgb(245,245,245);">
            <div class="card-header" role="tab">
                <h5 class="mb-0"><a data-toggle="collapse" aria-expanded="false" aria-controls="accordion-1 .item-3" href="#accordion-1 .item-3" style="color: rgb(51,51,51);">If my fire department registers, do individual members have to pay for a linked account?</a></h5>
            </div>
            <div class="collapse item-3" role="tabpanel" data-parent="#accordion-1">
                <div class="card-body">
                    <p class="card-text">During our beta phase our website is free to use. Once we implement membership fees, the fire department will pay a monthly fee and have the ability to add as many members as they choose for free.</p>
                </div>
            </div>
        </div>
    </div>
